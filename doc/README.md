...
-   [Add IAP (NOT YET IMPLEMENTED)](./generic-properties-root-add-in-app-purchase-properties-add-iap-add-iap-not-yet-implemented.md) – `mod.json#/properties/iap/properties/add/items`
-   [Add difficulty (NOT YET IMPLEMENTED)](./generic-properties-root-add-difficulty-properties-add-difficulty-add-difficulty-not-yet-implemented.md) – `mod.json#/properties/difficulty/properties/add/items`
...
-   [Add furniture (NOT YET IMPLEMENTED)](./generic-properties-root-add-furniture-properties-add-furniture-add-furniture-not-yet-implemented.md) – `mod.json#/properties/furniture/properties/add/items`
-   [Add marketing campaign (NOT YET IMPLEMENTED)](./generic-properties-root-add-marketing-campaign-properties-add-marketing-campaign-add-marketing-campaign-not-yet-implemented.md) – `mod.json#/properties/marketing_campaign/properties/add/items`
...
-   [Root: Add In-App Purchase](./generic-properties-root-add-in-app-purchase.md "To manipulate IAP (NOT IMPLEMENTED YET)") – `mod.json#/properties/iap`
-   [Root: Add difficulty](./generic-properties-root-add-difficulty.md "To manipulate custom difficulties (NOT IMPLEMENTED YET)") – `mod.json#/properties/difficulty`
...
-   [Root: Add furniture](./generic-properties-root-add-furniture.md "To manipulate furnitures (NOT IMPLEMENTED YET)") – `mod.json#/properties/furniture`
...
-   [Root: Add marketing campaign](./generic-properties-root-add-marketing-campaign.md "To manipulate marketing campaign (NOT IMPLEMENTED YET)") – `mod.json#/properties/marketing_campaign`
...
-   [Add IAP](./generic-properties-root-add-in-app-purchase-properties-add-iap.md "Add a new IAP") – `mod.json#/properties/iap/properties/add`
...
-   [Add furniture](./generic-properties-root-add-furniture-properties-add-furniture.md "Add a new item") – `mod.json#/properties/furniture/properties/add`
...
-   [Add marketing campaign](./generic-properties-root-add-marketing-campaign-properties-add-marketing-campaign.md "Add a new marketing campaign") – `mod.json#/properties/marketing_campaign/properties/add`
